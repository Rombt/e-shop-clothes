...
<div class="comments" id="comments">
    ...
    <div class="line-item comment_container">
        <textarea id="message" name="comment" tabindex="1" class="message" required="required" placeholder="<?php esc_html_e('Type here your comment','ale'); ?>"></textarea>
    </div>

    <?php if (!is_user_logged_in()) : ?>
    <div class="line-item cf">
        <div class="third_item">
            <input type="text" name="author" id="author" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> required="required" placeholder="<?php esc_html_e('Your name*','ale'); ?>" />
        </div>
        <div class="third_item">
            <input type="email" name="email" id="email" tabindex="3" <?php if ($req) echo "aria-required='true'"; ?> required="required" email="true" placeholder="<?php esc_html_e('Your e-mail*','ale'); ?>" />
        </div>
        <div class="third_item last">
            <input type="text" name="url" id="url" tabindex="4"  placeholder="<?php esc_html_e('Your website','ale'); ?>"/>
        </div>
    </div>
    <?php endif; ?>
