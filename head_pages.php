...
<body <?php body_class(); ?>>
    ...
    <?php  if (is_home()) { echo 'is_home()'; }  // срабатывает на странице блога. Есле главной страниценй сайта назначена динамическая страница с последними записями то сработает на ней и не сработает на странице с слагом blog?>                            
    <?php  if (is_front_page()) { echo 'is_front_page()'; }  // срабатывает на странице которая назначена главной в не зависимости того какой шаблон для неё выбран?>       
