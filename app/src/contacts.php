			...
			<div class="contact-us">
				<div class="contact-us__touch">
					...
					<form action="#" class="contact-us__form form">
						...
						<div class="form__input">
							<svg>
								<use xlink:href="<?php echo get_template_directory_uri() ?>/assets/img/icons/sprite.svg#messages">
								</use>
							</svg>
							<p>Message*</p>
				...
				<div class="contact-us__address">
					...
					<div>
						<h3>Phone</h3>
						<a href="tel:<?php echo class_exists('ReduxFramework') ? preg_replace('![^0-9]+!', '', $restaurant_site_options['our-phone']) : "" // delete spaces
											?>">
