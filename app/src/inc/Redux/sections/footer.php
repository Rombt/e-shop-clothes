...
Redux::set_section(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'id' => 'footer_form_section-accordion-start',
				'type' => 'accordion',
				'title' => esc_html__( 'Footer Form Section', 'restaurant-site' ),
				'subtitle' => 'All form settings of footer in this section ',
				'position' => 'start',
			),

			array(
				'id' => 'footer-form-section_form-subtitle',
				'type' => 'text',
				'title' => esc_html__( 'Form Subtitle', 'restaurant-site' ),
				'default' => esc_html__( 'Enter your email address and subscribe daily newsletter', 'restaurant-site' ),
			),

			array(
				'id' => 'footer-form-section_form_email-icon',
				'type' => 'media',
				'url' => true,
				...
				'default' => array(
					'url' => esc_url( get_template_directory_uri() ) . '/assets/img/icons/sprite.svg#form_email_2'
				),
			),


			array(
				'id' => 'footer_form_section-accordion-end',
				'type' => 'accordion',
				'position' => 'end'
			),
