...
function restaurant_site_scripts_login_page()
{
	wp_enqueue_script('restaurant_site-login_page', plugins_url() . '/restaurant-site-core/assets/js/modules/login_page.js', array('jquery'), '1.0', true);
}
add_action('login_enqueue_scripts', 'restaurant_site_scripts_login_page');
