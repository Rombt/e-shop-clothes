	...
	<div class="recipe-details__row">
		...
		<div class="white-box">
			...
			<div class="white-box__download">
				<a download href="<?php esc_attr_e(wp_upload_dir()['baseurl'] . '/files recipes/' . get_post_meta(get_the_ID(), 'file_recipe', true)) ?>">
					<img src="<?php echo rstr_get_pic_url('icon_download_file_recipe') ?>" alt="">
					<p>
						Download
		...
		<div class="recipe-details__blocks">
			<div class="ingredients">
				...
				<ul>
					...
					foreach ($arr_ingredients as $value) : ?>
						<li>
							<img src="<?php echo rstr_get_pic_url('marker_list_ingr_img') ?>" alt="">
							<p>
			...
			<div class="wrap-img recipe-details__blocks-img">
				<img src="<?php echo rstr_get_pic_url('small_img') ?>" alt="">
			</div>
		</div>
	<?php else :
		// something
