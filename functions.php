...
function simple_restaurant_site_scripts()
{
	...
	wp_enqueue_style('simple_restaurant_site-general', get_template_directory_uri() . '/assets/css/general.css', array(), '1.0', 'all');
	wp_enqueue_script('simple_restaurant_site-app.min', get_template_directory_uri() . '/assets/js/app.min.js', array(), '1.0', true);
