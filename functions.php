 ...
 *		Пагинация 
 *			при отсутствии следующих страниц кнобки prev и next не добжны пропадать а должны менять свет становясь не активными
 *			1:22:05	F:\Личное\WP уроки\Весь WordPress и PHP. Как создавать сайты, темы и плагины (2022) WEB-DL [Часть 3]\12. Extra! Advanced Level. Практика по разработке Премиум WordPress Темы
 *			Пагинацию в отдельную функцию
