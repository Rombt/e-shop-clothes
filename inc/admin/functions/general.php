...
function rstr_get_breadcrumbs() {
    ...
    if (is_home() || is_front_page()) {  
        ...
        if ($show_home_link == 1) {
            ...
            if ($frontpage_id == 0 || $parent_id != $frontpage_id) echo rstr_wp_kses($delimiter);
        }
        ...
        if ( is_category() ) {
            ...
            if ($show_current == 1) echo rstr_wp_kses($before) . sprintf($text['category'], single_cat_title('', false)) . rstr_wp_kses($after);
            ...
            if ( get_post_type() != 'post' ) {
                ...
                if ($show_current == 1) echo rstr_wp_kses($delimiter) . rstr_wp_kses($before) . get_the_title() . rstr_wp_kses($after);
            } else {
                ...
                if ($show_title == 0) $cats = preg_replace('/ title="(.*?)"/', '', $cats);
                echo rstr_wp_kses($cats);
                if ($show_current == 1) echo rstr_wp_kses($before) . get_the_title() . rstr_wp_kses($after);
            }
            ...
            if ($parent_id != $frontpage_id) {
                ...
                for ($i = 0; $i < count($breadcrumbs); $i++) {
                    ...
                    if ($i != count($breadcrumbs)-1) echo rstr_wp_kses($delimiter);
                }
            }
            if ($show_current == 1) {
                if ($show_home_link == 1 || ($parent_id_2 != 0 && $parent_id_2 != $frontpage_id)) echo rstr_wp_kses($delimiter);
