...
<section class="conteiner opening-hours-conteiner">
   ...
   <div class="opening-hours-conteiner__row">
      <div class="opening-hours-conteiner__title">
         <h2><?php echo class_exists('ReduxFramework') ? esc_html($restaurant_site_options['opening-hours_maine-title'], 'restaurant-site') : "" ?></h2>
      </div>

      <p>
         <?php echo class_exists('ReduxFramework') ? esc_html($restaurant_site_options['opening-hours_title-1'], 'restaurant-site') : "" ?>
         <?php _e(wp_kses($restaurant_site_options['opening-hours_subtitle-1'], 'post'), 'restaurant-site') ?>
      </p>
      <p>
         <?php echo class_exists('ReduxFramework') ? esc_html($restaurant_site_options['opening-hours_title-2'], 'restaurant-site') : "" ?>
